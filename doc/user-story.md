...
#### 故事卡片
作为握有大量数据需要識读的研究或商业的机构，我需要发起项目来请求网络上的广大群众来协助我完成任物。

#### 细节
- 我需要能发起项目，在其中描述我的任物细节与要求，并且上传或提供我的数据所在位置。
- 我希望能客制化我的数据显示方式，因为可能是图片或是文本、或是多媒体文件。
- 我希望能客制化接包方完成任物的方式，因为我可能希望对于每份数据中，接包方要以回答选择题、简答题、是非题等不同形式的题目。也有可能希望接包方回传一份加注过的文本或是多媒体文件。
