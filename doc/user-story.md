...
- 我希望能客制化接包方完成任务的方式，因为我可能希望对于每份数据中，接包方要以回答选择题、简答题、是非题等不同形式的题目。也有可能希望接包方回传一份加注过的文本或是多媒体文件。
...
#### 故事卡片
作为刚发布完项目的我，发现项目有部份细节缺失，我希望能够修改项目的内容。
...
#### 故事卡片
作为项目发布者，我要能够随时查看已经返回的任務结果，并能对接包方发送反馈。
